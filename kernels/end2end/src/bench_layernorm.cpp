 ...
 *
 * This is a separate binary so adding the BERT-specific normalization does
 * not change the code layout or provenance of the existing bench_kernel
 * results used by the other layer components.
 */
