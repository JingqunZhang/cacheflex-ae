...
#
# Plot-from-best-run (canonical plotter = plot_fig2_real.py; it expects
...
#   RESULTS_DIR="$P" python3 plot_fig2_real.py
#
...
Plot a finished best run with plot_fig2_real.py (see the plot-from-best-run
