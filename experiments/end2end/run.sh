#!/bin/bash
# run.sh — unified AE run interface for experiments/end2end (Figure 9).
#
#   default   : FRESH gem5 runs of ONLY the cells pinned in best.json, grouped
#               by vector length under the two canonical plotter pools:
#                 results/generated/simulation_results/vl4/
#                 results/generated/simulation_results/vl16/
...
#   RESULTS_DIR=results/generated python3 scripts/plot_fig9_real.py
#
...
python3 scripts/plot_fig9_real.py.
...
rh_compat_layout "$GEN/simulation_results/vl4"
rh_compat_layout "$GEN/simulation_results/vl16"
exit $RC
